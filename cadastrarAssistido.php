<?php
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($Nome_Completo) && !empty($Data_Nascimento) && !empty($Idade_Cog) && !empty($Nome_Responsavel) && !empty($CPF)) {
      // Query de inserção
    ...
    <div class="container">
      ...
      <form class="row g-3" method="POST" action="">
        ...
        <div class="col-md-6">
          ...
          <input type="number" class="form-control" id="inputDataNascimento" name="Data_Nascimento" value="" required/>
        </div>
        <div class="col-md-6">
          <label for="inputIdade" class="form-label">Idade Cognitiva*</label>
          <input type="number" class="form-control" id="inputIdade" name="Idade_Cog" maxlength="2" value="" required />
        </div>
        <div class="col-md-6">
